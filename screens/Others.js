...
const Others = () => {
  const optionsData = [
    { id:1,option: '100 mins', amount: 300, desc:`Ksh.300 7 days` },
    { id:2,option: '500 mb', amount:20, desc: `Ksh.20 till midnight` },
  ...
  const handleNext = () => {
    ...
    return (
     <SafeAreaView style={styles.container}>
      ...
      <View>
        <Text style={{color:'#dc2626', fontSize:20, fontWeight:'bold'}}>Other deals</Text>
